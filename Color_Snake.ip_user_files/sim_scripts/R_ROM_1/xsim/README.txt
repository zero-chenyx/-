...
#
# Generated by export_simulation on Wed Jul 29 21:40:16 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './R_ROM.sh' script.
...
./R_ROM.sh -noclean_files

For more information on the script, please type './R_ROM.sh -help'.
