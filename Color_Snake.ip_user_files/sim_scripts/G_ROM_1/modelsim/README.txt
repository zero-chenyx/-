...
#
# Generated by export_simulation on Wed Jul 29 21:41:42 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './G_ROM.sh' script.
...
./G_ROM.sh -noclean_files

For more information on the script, please type './G_ROM.sh -help'.
